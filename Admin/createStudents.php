...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    value('$firstName','$lastName','$otherName','$admissionNumber','$sampPass','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    otherName='$otherName', admissionNumber='$admissionNumber',password='$password', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="email" class="form-control" name="otherName" value="<?php echo $row['otherName'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
