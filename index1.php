...
<body class="bg-gradient-login" style="background-image: url('img/KIIT-Classroom.jpg');" id=LogIn>
    <!-- Login Content -->
  ...
  if(isset($_POST['login'])){
    ...
    if($userType == "Administrator"){
      ...
      if($num > 0){
        ...
        echo "<div class='alert alert-danger' role='alert'>
        Invalid Username/Password for teacher! 
        </div>";
        ...
        echo "<script type = \"text/javascript\">
        window.location = (\"QRCodeGenerator/index.php\")
        </script>";
        ...
        echo "<div class='alert alert-danger' role='alert'>
        Invalid Username/Password! for student
        </div>";
